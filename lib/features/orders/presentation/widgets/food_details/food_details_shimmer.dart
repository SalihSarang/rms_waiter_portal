    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          // Image Shimmer
          const RmsSkeletonBlock(height: 240, width: double.infinity, borderRadius: 20),
          const SizedBox(height: 24),
          // Title Shimmer
          const RmsSkeletonBlock(height: 32, width: 200, borderRadius: 8),
          const SizedBox(height: 8),
          // Description Shimmer
          const RmsSkeletonBlock(height: 16, width: double.infinity, borderRadius: 4),
          const SizedBox(height: 8),
          const RmsSkeletonBlock(height: 16, width: double.infinity, borderRadius: 4),
          const SizedBox(height: 24),
          ...
          const RmsSkeletonBlock(height: 60, width: double.infinity, borderRadius: 16),
          const SizedBox(height: 12),
          const RmsSkeletonBlock(height: 60, width: double.infinity, borderRadius: 16),
          const SizedBox(height: 24),
        ],
